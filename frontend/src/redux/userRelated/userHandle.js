...
//     try {
//         const result = await ax}/${role}Reg`, fields, {
//             headers: { 'Content-Type': 'application/json' },
//         });
...
//     try {
//         const result = await a}/${address}/${id}`);
//         if (result.data) {
...
// //     try {
// //         const result = await axio}/${address}/${id}`);
...
//     try {
//         const result = await a}/${address}/${id}`, fields, {
//             headers: { 'Content-Type': 'application/json' },
//         });
//         if (result.data.schoolName) {
//             dispatch(authSuccess(result.data));
...
//     try {
//         const result = await ax}/${address}Create`, fields, {
//             headers: { 'Content-Type': 'application/json' },
//         });
